...
class UserPayProfile {
  ...
  UserPayProfile copyWith({
    ...
    return UserPayProfile(
      ...
      genereDiConfortoRate: genereDiConfortoRate ?? this.genereDiConfortoRate,
  ...
  factory UserPayProfile.fromJson(Map<String, dynamic> json) {
    return UserPayProfile(
      ...
      orderPublicInSede: (json['orderPublicInSede'] as num?)?.toDouble() ?? 6.0,
      ...
      holidayAllowance: (json['holidayAllowance'] as num?)?.toDouble() ?? 8.0,
      specialHolidayAllowance:
      ...
      detectedBaseSalary: (json['detectedBaseSalary'] as num?)?.toDouble() ?? 0,
      averageAccessoryPay:
      ...
      effectiveTaxRate: (json['effectiveTaxRate'] as num?)?.toDouble() ?? 0.27,
      ...
      ticketPastoRate: (json['ticketPastoRate'] as num?)?.toDouble() ?? 7.00,
      straordinarioNetMultiplier:
